    ...
    return newRequire;
            ...
            function toFormData(obj, formData, options) {
                ...
                function build(value, path) {
                    if (_utils.default.isUndefined(value))
                        return;
            ...
            const { Axios, AxiosError, CanceledError, isCancel, CancelToken, VERSION, all, Cancel, isAxiosError, spread, toFormData, AxiosHeaders, HttpStatusCode, formToJSON, mergeConfig } = _axios.default;
            ...
            var showAlert = function showAlert(type, msg) {
                hideAlert();
                var markup = "<div class=\"alert alert--".concat(type.toLowerCase(), "\">").concat(msg, "</div>");
            ...
            var displayMap = function displayMap(locations) {
                ...
                locations.forEach(function (element) {
                    ...
                    new mapboxgl.Popup({
                        offset: 30
                    }).setLngLat(element.coordinates).setHTML("<p> ".concat(element.day, " : ").concat(element.description, "</p>")).addTo(map);
            ...
            var updateProfile = document.querySelector('.form-user-data');
            if (updateProfile) {
